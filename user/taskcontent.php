    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($task) || empty($attachment)) {
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                $updateSql = "UPDATE projects SET work_status = 'In Progress' WHERE project_title = '$project_name'";
                ...
                $updateSql = "UPDATE task SET status = 'In Progress' WHERE project_title = '$project_name'";
