...
if (isset($_POST['signup'])) {
    ...
    $checkUserQuery = "SELECT * FROM employees WHERE username = '$uname' OR email = '$email'";
    ...
    if ($result->num_rows > 0) {
        ...
        $insertQuery = "INSERT INTO `employees` (`username`, `email`, `password`) VALUES('$uname','$email','$upass')";
        if (mysql_query("INSERT INTO `employees` (`username`, `email`, `password`) VALUES('$uname','$email','$upass')")) {
