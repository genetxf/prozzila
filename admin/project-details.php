            ...
            <div class="col-12">
                <div class="box project">
                    ...
                    <div class="box-body content">
                        ...
                        <ul class="list-img">
                            <li>
                                <div class="img-dv"><img style=" width: 320px;"
                                                         src="./images/product/<?php echo $department; ?>1.jpg" alt="">
                                </div>

                            </li>
                            <li>
                                <div class="img-dv"><img style=" width: 320px;"
                                                         src="./images/product/<?php echo $department; ?>2.jpg" alt="">
                                </div>

                            </li>
                            <li>
                                <div class="img-dv"><img style=" width: 320px;"
                                                         src="./images/product/<?php echo $department; ?>3.jpg" alt="">
                                </div>

                            </li>
                            <li>
                                <div class="img-dv">
                                    <img style=" width: 320px;" src="./images/product/<?php echo $department; ?>4.jpg"
                                         alt="">
                                            ...
                                            if ($result2->num_rows > 0) {
                                                while ($row = $result2->fetch_assoc()) {
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="deletetskpr.php?data=<?php echo urlencode($row["id"]); ?>"
                                                               class="btn btn-success submit-btn">Complete</a></td>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-vcenter text-nowrap table-bordered dataTable no-footer mw-100"
                                            ...
                                            <tr class="top">
                                                ...
                                                <th class="border-bottom-0 sorting_disabled fs-14 font-w500" rowspan="1"
                                                    colspan="1" style="width: 145.391px;">Action
                                                </th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                        ...
                                                        if ($resultcon->num_rows > 0) {
                                                            while ($row = $resultcon->fetch_assoc()) {
                                                                ...
                                                                <tr class="odd">
                                                                    ...
                                                                    <td>
                                                                        <a href="../images/work/<?php echo $row["attachment"]; ?>"
                                                                           class="btn btn-primary" download>
                                                                            <span>Download</span>
                                                                        </a>
                                                                        <a href="deletetskcon.php?data=<?php echo urlencode($row["id"]); ?>"
                                                                           class="btn btn-danger submit-btn">Delete</a>
                                                                    </td>
