...
<div class="main">
    ...
    <div class="main-content board">
                                        ...
                                        <div class="panel">
                                            <div class="kanban-box item-box ui-sortable-handle">
                                                ...
                                                <div class="content-box">
                                                    ...
                                                    <div class="progress skill-progress mt-15 mb-15"
                                                         style="height:7px;">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <div class="d-flex justify-content-between text-primary"
                                                             data-toggle="modal" data-target="#add_task_modal"><a
                                                                    href="#"><i class="bx bxs-plus-circle"
                                                                                style="font-size: 40px;"></i></a></div>
                                                        <div class="d-flex time">
                                                            <p class="font-main mb-0"><i class="far fa-clock"></i>Due in
                                                                5 days</p>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div id="add_task_modal" class="modal custom-modal fade" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
