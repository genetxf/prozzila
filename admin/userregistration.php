...
if (isset($_POST['signup'])) {
    ...
    $checkUserQuery = "SELECT * FROM prozzila.employees WHERE username = '$uname' OR email = '$email'";
    ...
    if ($result->num_rows > 0) {
        ...
        $insertQuery = "INSERT INTO `prozzila`.employees (`username`, `email`, `password`) VALUES('$uname','$email','$upass')";
        if (mysql_query("INSERT INTO `prozzila`.employees (`username`, `email`, `password`) VALUES('$uname','$email','$upass')")) {
